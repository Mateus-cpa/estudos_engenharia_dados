...
> Os principais estudos acerca da temática de redes de computadores envolvem proteção e privacidade de dados.

### Topologia de rede

> A topologia, ou disposição física, dos computadores podem se apresentar de diferentes formas.
...
> No PaaS é preciso que cada decisão seja tomada com cautela e visando ao mesmo tempo a economia.

> No modelo PaaS se utiliza uma plataforma como um serviço (por exemplo: plataformas em nuvem tipo Microsoft Azure).
...
> O modelo SaaS é um modelo de aplicação de um público amplo e em diferentes ramos, como streamings de áudio e vídeo.
